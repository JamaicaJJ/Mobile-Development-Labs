...
let user1 = User(userName: "David", email: "Davidemail.com", age: 18)
let user2 = User(userName: "Maria", email: "Mariaemail.com", age: 17)


if let currentUser = User.currentUser {
    print("Current logged-in user is: \(currentUser.userName)")
}
