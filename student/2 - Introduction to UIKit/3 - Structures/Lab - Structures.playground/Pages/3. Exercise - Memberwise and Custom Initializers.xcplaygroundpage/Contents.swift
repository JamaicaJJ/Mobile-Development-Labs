...
let favoriteBook = Book(title:" Elprincipito", author: "Marco", pages: 200, price: 5)
print("My favorite Book has \(favoriteBook.pages) pages ")
/*:
 ...
 */
struct Laptop {
    var screeenSize : Int = 13
    var repairCount : Int = 0
    var yearPurchased : Int
    
}
let myLaptop = Laptop(screeenSize: 12, repairCount: 0, yearPurchased: 2024)
print(myLaptop)

let myFriendLaptop = Laptop(screeenSize: 15, repairCount: 4, yearPurchased: 2020)
/*:
...
struct altura {
    ...
    var heightInCentemiters : Double = 0
    init (heightInInches: Double) {
        self.heightInInches = heightInInches
        heightInCentemiters = (heightInInches)*2.54
    }
}
print(altura(heightInInches:70))
...
var height = altura(heightInInches: 65)
print(height)
...
var myheight = altura (heightInInches: 55)
print(myheight)
