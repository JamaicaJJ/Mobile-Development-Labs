...
let unWrapUserAge = userAge!


//Value of optional Int must be unwrapped to a value of type Int.
...
// The value of userAge is nil because the string cannot be converted to an integer.
/*:
